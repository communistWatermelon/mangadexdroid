...
internal interface MangaService {
    ...
    suspend fun changeReadStatus(token: AuthToken, uiManga: com.melonhead.data_core_manga_ui.UIManga, uiChapter: com.melonhead.data_core_manga_ui.UIChapter, readStatus: Boolean)
}
...
internal class MangaServiceImpl(
    ...
    override suspend fun changeReadStatus(token: AuthToken, uiManga: com.melonhead.data_core_manga_ui.UIManga, uiChapter: com.melonhead.data_core_manga_ui.UIChapter, readStatus: Boolean) {
