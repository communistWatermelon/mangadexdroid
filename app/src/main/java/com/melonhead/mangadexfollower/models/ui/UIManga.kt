...
@Parcelize
@Serializable
data class UIManga(val id: String, val title: String, val chapters: List<UIChapter>, val coverFilename: String?, val useWebview: Boolean, val altTitles: List<String>) :
    Parcelable {
    @IgnoredOnParcel
